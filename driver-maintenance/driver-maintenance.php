...
<body>
    ...
    <div class="menu-body">
      ...
      <ul id="navLinks">
        ...
        <li>
          ...
          <ul>
            <li>
              <a class="active" style="color: #470A34;" href="../driver-maintenance/driver-maintenance.php">View History</a>
            </li>
          </ul>
        </li>
        <li>
    ...
    <div class="card-body">
      <div class="d-md-flex gap-4 align-items-center">
        ...
        <div class="dropdown ms-auto">
          <a href="#" class="btn btn-primary" aria-haspopup="true" aria-expanded="false"> Request Maintenance</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="table-responsive">
    <table class="table table-custom table-lg mb-0" id="Vehicles">
      ...
      <tr>
        <td>Engine Issues</td>
        <td>The engine of the car is bad</td>
        <td>23/06/2023</td>
        <td>
      ...
      <tr>
        <td>Body Work </td>
        <td>The back of the car needs to be resprayed</td>
        <td>23/06/2023</td>
        <td>
        <span class="text-end badge bg-danger">Rejected</span>
        </td>
      </tr>
      </tbody>
    </table>
