...
<div class="container">
  ...
  <h4>Welcome to CU Fleet Management System</h4>
    ...
    <a class="btn" style="text-decoration: none; background: transparent; border: 2px solid #470A34; color:#470A34;" href="./guest-form.html" role="button">Continue as Guest</a>
  </form>
</div>
